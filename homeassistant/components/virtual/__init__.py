...
def get_entity_configs(hass: HomeAssistant, group_name: str, domain: str) -> list[dict]:
    """Get entity configs."""
    return (
...
def get_entity_from_domain(hass: HomeAssistant, domain: str, entity_id: str):
...
async def async_virtual_set_availability_service(hass: HomeAssistant, call):
