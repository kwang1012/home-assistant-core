...
class VirtualDoor(VirtualEntity, CoverEntity):  # pylint: disable=hass-enforce-class-module
    ...
    def __init__(self, config) -> None:
        ...
        self.tilt_tasks: set[asyncio.Task] = set()
...
class CoordinatedVirtualDoor(CoordinatedVirtualEntity, VirtualDoor):  # pylint: disable=hass-enforce-class-module
