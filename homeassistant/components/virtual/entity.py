...
def virtual_schema(default_initial_value: str, extra_attrs) -> dict:
...
class VirtualEntity(RestoreEntity):
    ...
    def __init__(self, config, domain) -> None:
        ...
        self._config = config
        self._attr_should_poll = not config.get(CONF_PUSH, False)
        ...
        if not self._attr_name:
            raise ValueError("Name is required for virtual entities")
