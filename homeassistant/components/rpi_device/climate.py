...
async def async_setup_entry(
    ...
    """Set up thermostat."""
    devices: list[RaspberryPiThermostat] = hass.data[DOMAIN][config_entry.entry_id].get(  # pylint: disable=hass-use-runtime-data
        "thermostat", []
    )
    async_add_entities([RpiThermostat(device) for device in devices])
