"""Generate YAML entity config files for the rasc integration."""
...
def main():
    """Generate device entity configuration YAML from routines config."""
    ...
    generated_config = {"version": 1, "devices": devices}

    with open(
        "homeassistant/components/rasc/datasets/generated.yaml", "w", encoding="utf-8"
    ) as out_f:
        yaml.dump(generated_config, out_f)
